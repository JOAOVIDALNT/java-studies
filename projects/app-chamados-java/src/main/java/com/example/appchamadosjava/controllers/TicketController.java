...
public class TicketController {
    ...
    @PostMapping
    public ResponseEntity<TicketDTO> create(@Valid @RequestBody TicketDTO ticketDTO) throws Exception {
    ...
    public ResponseEntity<TicketStatusUpdateDTO> updateStatus(@PathVariable Long id, @RequestBody TicketStatusUpdateDTO ticketStatusUpdateDTO) {
        return new ResponseEntity<>(ticketService.updateStatus(id, ticketStatusUpdateDTO), HttpStatus.OK);
    }

    @PutMapping("/problem/{id}")
    public ResponseEntity<TicketProblemUpdateDTO> updateProblem(@PathVariable Long id, @RequestBody TicketProblemUpdateDTO ticketProblemUpdateDTO) {
        return new ResponseEntity<>(ticketService.updateProblem(id, ticketProblemUpdateDTO), HttpStatus.OK);
    }

    @PutMapping("/review/{id}")
    public ResponseEntity<TicketAddReviewDTO> addReview(@PathVariable Long id, @RequestBody TicketAddReviewDTO ticketAddReviewDTO) {
